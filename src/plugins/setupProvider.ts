const modulesFiles = import.meta.glob('/src/provider/*.ts', { eager: true }) as unknown as CustomProvider.Provider

const convertSymbolToNormalStr = (obj: Pick<CustomProvider.Provider, 'inject' | 'test'>): Partial<CustomProvider.Provider> => {
