...
export default class UtilService {
  ...
  public async deepClone(
    obj: Parameters<typeof deepClone>[0]
  ): ReturnType<typeof deepClone> {
  ...
  public mapKeys(
    obj: Parameters<typeof mapKeys>[0],
    keymap: Parameters<typeof mapKeys>[1]
  ...
  public customPrint(
    options: Parameters<typeof customPrint>[0]
  ): ReturnType<typeof customPrint> {
    customPrint(options)
  }
